...
Udacity Data Engineering Nanodegree projectone
...
used the star schema, which is denormalized, so that we can have the benefits of 
    - Denormalized
    - Simplifies queries
    - Fast aggregations
...
## Instructions
    ...
    4. Run test.ipynb to confirm your records were successfully inserted into each table. Make sure to click "Restart kernel" to close the connection to the database after running the notebook.
